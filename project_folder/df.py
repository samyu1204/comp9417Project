...
# * ========================================================================================
# Processing of all column averages ignoring all NA values in columns:
...
# Merging the data by cutsomer_id
...
# Get a list of all column averages
def get_column_avg():
  avg = []
  data = get_train_data()
  data = data.groupby(['customer_ID']).mean()
