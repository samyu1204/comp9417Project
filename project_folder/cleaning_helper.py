...
# Returns a dataframe with a few features:
...
# Selection of a dataframe based on elements in the list fed into the function
def select_by_list(l, df):
  return df[l]

# Checking NA in every column in the data frame
